...
export const voiceNotes: VoiceNote[] = [
  {
    ...
    visitId: IDS.visitDone,
    mrId: IDS.mr,
    storageKey: 'voice-notes/2026/08/10/66666601.m4a',
...
export const recordings: Recording[] = [
  {
    ...
    storageKey: 'recordings/2026/08/10/66666601.m4a',
    durationSeconds: 1012,
    // MR-52 C1 / BE-W111: AAC in an MP4 container, which is what the recorder writes.
    codec: 'aac',
    bitrateKbps: 28,
    uploadStatus: 'uploaded',
    recordedAt: T(10, 5),
