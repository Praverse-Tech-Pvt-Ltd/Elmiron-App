 ...
 * are `PrimaryButton`s. Rendering "Carry on by hand" as a quieter, secondary,
 * text-only control while "Turn location back on" gets the filled button is exactly
 * the coercion this screen is designed not to be — the design says two equal actions,
 * and a visual hierarchy would be the app arguing with the MR's decision after
 * claiming to accept it.
 *
